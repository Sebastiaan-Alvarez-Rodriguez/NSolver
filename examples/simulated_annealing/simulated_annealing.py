...
class SimulatedAnnealing(Solver):
    ...
    def __init__(self):
        ...
        x = generate_random_answer(n, dim)
        f = evaluate(x)  # evaluate the solution using fitness_func
    ...
    @staticmethod
    def mutate_answer(s, n, dim, pm, f, fopt):
        ...
        Args:
            ...
            f (double): The fitness value of our current solution `s`.
            fopt (double): The fitness value of the currently known most optimal solution.
        Returns:
